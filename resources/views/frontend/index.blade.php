...
<section class="home-section-1">
    <div class="container">
        <div class="row py-5">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-4 text-end"><img src="assets/img/home/claim-icon.png" alt=""></div>
                    <div class="col-md-4 text-center"><img src="assets/img/home/payment-icon.png" alt=""></div>
                    <div class="col-md-4"><img src="assets/img/home/billing-icon.png" alt=""></div>
                </div>
            </div>
        </div>
    </div>
...
<section class="home-section-2">
    <div class="container">
        <div class="row py-5">
            ...
            <div class="col-md-6">
                <img src="./assets/img/home/section2img.png" alt="">
            </div>
        </div>
    </div>
                    ...
                    <div class="row px-3">
                        ...
                        <div class="col-md-6">
                            <div class="what_we_img">
                                <img src="assets/img/home/1-image-what-we-do.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid">
                <div class="row text-center mt-5">
                    <div class="col-md-6 col-lg-3 text-center">
                        <div class="card">
                            <img class="vector" src="./assets/img/home/vector-smart-object.png" alt="Image 1">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            <img class="vector" src="./assets/img/home/vector-smart-object1.png" alt="Image 2">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            <img class="vector " src="./assets/img/home/vector-smart-object3.png" alt="Image 4">
                ...
                <div class="row ">
                    <div class="col-md-6 col-lg-3">
                        <div class="card text justify-content-center">
                            <img class="vector" src="./assets/img/home/vector-smart-object4.png" alt="Image 5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            <img class="vector" src="./assets/img/home/vector-smart-object5.png" alt="Image 6">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            <img class="vector" src="./assets/img/home/vector-smart-object6.png" alt="Image 7">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            <img class="vector" src="./assets/img/home/vector-smart-object7.png" alt="Image 8">
        ...
        <div class="d-flex flex-wrap flex-row svg_process my-5">
            <div class="mx-md-3 what_service text-center service_hd slide_1" onclick="active_service(1)">
               <div class="corrsponding_icons">
                    <img src="./assets/img/home/icon-reduce-operational-expenses.png" alt="">
               </div>
            ...
            <div class="mx-2 mx-md-3 what_service text-center service_hd slide_2" onclick="active_service(2)">
               <div class="corrsponding_icons pt-3">
                    <img src="./assets/img/home/icon-ensure-transparency.png" alt="">
               </div>
            ...
            <div class="mx-md-3 what_service text-center service_hd slide_3" onclick="active_service(3)">
               <div class="corrsponding_icons">
                    <img src="./assets/img/home/vector-smart-object11.png" alt="">
               </div>
            ...
            <div class="mx-2 mx-md-3 what_service text-center service_hd slide_4" onclick="active_service(4)">
               <div class="corrsponding_icons">
                    <img src="./assets/img/home/vector-smart-objectq.png" alt="">
               </div>
        ...
        <div class="detail_process">
            <div class="process-detail-contant text-light process_inactive slide_content_1">
                <div class="row px-3">
                    <div class="col-lg-6">
                        <div class="what_we_img">
                            <img src="assets/img/home/img_operational_cost.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="process-detail-contant text-light process_inactive slide_content_2">
                <div class="row px-3">
                    <div class="col-lg-6">
                        <div class="what_we_img">
                            <img src="assets/img/home/image-ensure-transparency.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="text_process_what_we py-5">
            ...
            <div class="process-detail-contant text-light process_inactive slide_content_3">
                <div class="row px-3">
                    <div class="col-lg-6">
                        <div class="what_we_img">
                            <img src="assets/img/home/img_enhance_customer_experience.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="text_process_what_we py-5">
            ...
            <div class="process-detail-contant text-light process_inactive slide_content_4" >
                <div class="row px-3">
                    <div class="col-lg-6">
                        <div class="what_we_img">
                            <img src="assets/img/home/img_improved_revenue.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="text_process_what_we py-5">
        ...
        <div>
            ...
            <div class="row" style="margin-top: 75px;">
                <div class="col-6" style="padding: 0">
                    <img class="w-100" src=".\assets\img\home\0-6-signup-section-doctor-image.png" alt="image" >
                </div>
                <div class="col-5" style="padding: 0">
                    <form class="seven-form" style="    margin-left:0">
                        ...
                        <div class="form-group">
                            ...
                            <img class="seven-icon" src=".\assets\img\home\0-6-icon-choose-service.png" alt="Image 1">
                        </div>
                        <div class="form-group">

                            <input type="text" class="form-control text-grey" id="contact-details" placeholder="Contact Details">
                            <img class="seven-icon" src=".\assets\img\home\0-6-icon-contact-details.png" alt="Image 1">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control text-grey" id="date" placeholder="Choose Date">
                            <img class="seven-icon" src=".\assets\img\home\0-6-icon-choose-date.png" alt="Image 1">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control text-grey" id="time"  placeholder="Choose Time">
                            <img class="seven-icon" src=".\assets\img\home\0-6-icon-choose-time.png" alt="Image 1">
                        </div>
                ...
                <div class="carousel-item active">
                    <div class="main_testimonial">
                        <div class="testimonial_slide">
                            ...
                            <div class="testemonial_user"><img src="assets\img\home\img-0-7-v-1.png" alt="">
                        ...
                        <div class="testimonial_slide">
                            ...
                            <div class="testemonial_user"><img src="assets\img\home\img-0-8-v-2.png" alt="">
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-4">
                <div class="recent_news_block">
                    <img class="recent_news_img" src=".\assets\img\home\doctor-working-hospital-healthcare-medical-service.png" alt="image1" >
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="recent_news_block">
                    <img class="recent_news_img" src=".\assets\img\home\employees-closeup-young-nurse-service.png" alt="image2">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="recent_news_block">
                    <img class="recent_news_img" src=".\assets\img\home\doctor-working-hospital-use-calculator-healthcare-medical-concept-copy.png" alt="image3">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="recent_news_block">
                    <img class="recent_news_img" src=".\assets\img\home\handsome-doctor-portrait-background.png" alt="image4">
                    <div class="overlay d-flex align-items-center justify-content-center">
                        <button type="button" class="btn-card btn-outline">Read More</button>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="recent_news_block">
                    <img class="recent_news_img" src=".\assets\img\home\nurse-doctor-aid-background-cardiologist-care-exam.png" alt="image5">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="recent_news_block">
                    <img class="recent_news_img" src=".\assets\img\home\woman-doctor-wearing-lab-coat-with-stethoscope-isolated.png" alt="image6">
                    <div class="overlay d-flex align-items-center justify-content-center">
                        <button type="button" class="btn-card btn-outline">Read More</button>
                    </div>
                </div>
